 ...
 * @author rtspi
 */
public class ManageVolunteerOrganizationJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageVolunteerOrganizationJPanel(JPanel userProcessContainer,OrganizationDirectory directory, Enterprise enterprise) {
        initComponents();
    ...
    private void populateTable(){
        ...
        for (Organization organization : directory.getOrganizationList()){
        {
             ...
             if(organization instanceof HospitalOrganization || organization instanceof VolunteerOrganization ){
    ...
    private void initComponents() {
        ...
        jLabel4.setText("MANAGE VOLUNTEER UNIT ORGANIZATION");
