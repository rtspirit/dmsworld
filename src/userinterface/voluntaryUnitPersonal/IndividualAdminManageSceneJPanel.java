    ...
    private void populateSceneTable() {
        ...
        for (WorkRequest wr : organization.getWorkQueue().getWorkRequestList()) {
            ...
            if (wr instanceof VolunteerUnitRequest) {
                ...
                row[3] = ((VolunteerUnitRequest) wr).getNoOfVictims();
                row[4] = ((VolunteerUnitRequest) wr).getEstimatedLoss();
                row[5] = ((VolunteerUnitRequest) wr).getStatus();
                row[6] = ((VolunteerUnitRequest) wr).getRequestDate();
                row[7] = ((VolunteerUnitRequest) wr).getMessage();
